...
function generateBashCompletionScript(): string {
  return [
    ...
    '      ;;',
    '    apps)',
    '      if [[ "${sub}" == "list" ]]; then flag_candidates="--json";',
    '      elif [[ "${sub}" == "show" ]]; then flag_candidates="--file --json";',
    '      elif [[ "${sub}" == "plan" ]]; then flag_candidates="--action --file --dry-run --json";',
    '      elif [[ "${sub}" == "run" ]]; then flag_candidates="--action --file --dry-run --apply --json";',
    '      else flag_candidates="--file --dry-run --apply --json"; fi',
    '      ;;',
...
function generateFishCompletionScript(): string {
  return [
    ...
    '  complete -c $c -l json',
    '  complete -c $c -n "__fish_seen_subcommand_from reflect categorize insight insights" -l save',
    ...
    '  complete -c $c -n "__fish_seen_subcommand_from apps show plan run install start stop status doctor dashboard" -l file',
    '  complete -c $c -n "__fish_seen_subcommand_from apps plan run" -l action',
    '  complete -c $c -n "__fish_seen_subcommand_from apps plan run install start stop status doctor dashboard" -l dry-run',
    '  complete -c $c -n "__fish_seen_subcommand_from apps run install start stop status doctor dashboard" -l apply',
    ...
    '  complete -c $c -n "__fish_seen_subcommand_from soul step" -l state',
    '  complete -c $c -n "__fish_seen_subcommand_from soul step" -l action',
    '  complete -c $c -n "__fish_seen_subcommand_from soul step" -l limits',
