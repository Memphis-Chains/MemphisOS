...
function generateBashCompletionScript(): string {
  return [
    ...
    '    insights) flag_candidates="--weekly --input --query --save --json" ;;',
...
function generateFishCompletionScript(): string {
  return [
    ...
    'for c in memphis',
    '  complete -c $c -f -n "__fish_use_subcommand" -a "setup configure init health reflect learn insights connections suggest serve providers:health providers models chat ask categorize decide infer agents relationships trust mcp debug tui doctor onboarding chain sync trade soul vault embed completion help"',
    ...
    '  complete -c $c -l json',
    '  complete -c $c -n "__fish_seen_subcommand_from reflect categorize insights" -l save',
    '  complete -c $c -n "__fish_seen_subcommand_from insights" -l weekly',
    '  complete -c $c -n "__fish_seen_subcommand_from insights" -l input',
    '  complete -c $c -n "__fish_seen_subcommand_from insights" -l query',
